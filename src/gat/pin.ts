...
export const GAT_ENGINE_COMMIT = pin.engineCommit;
export const GAT_ENGINE_REPOSITORY = pin.engineRepository;
export const GAT_SOURCE_TREE_DIGEST = pin.sourceTreeDigest;
