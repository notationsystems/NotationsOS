...
import { getProductionSource, readCommittedSources } from '@/adapter/productionSource';
...
export default async function CandidatesPage() {
  ...
  const sources = await readCommittedSources(demo);
  return (
    <>
      ...
      <div className="p-3 sm:p-4 max-w-[1400px] mx-auto w-full flex flex-col gap-5">
        ...
        <CandidatePipeline demo={demo} sources={sources} />
      </div>
    </>
  );
}
